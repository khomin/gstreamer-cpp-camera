...
protected:
    ...
    //byte-stream=true
    // tune=zerolatency
    static constexpr auto cmd = "appsrc name=source_to_out ! videoconvert ! videoscale ! video/x-raw,format=I420,width=426,height=240,framerate=24/1 ! videoconvert ! queue ! vp8enc ! appsink name=sink_out";
